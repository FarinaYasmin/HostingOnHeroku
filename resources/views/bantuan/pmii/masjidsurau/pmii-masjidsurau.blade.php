...
<body>
    ...
    <form id="regForm" action="{{ route('bantuan.pmii.masjidsurau.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
        <h1>Mohon :</h1>
        ...
        <div class="tab">Maklumat Organisasi
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="textarea" name="alamat_organisasi" class="form-control" placeholder="Alamat Organisasi">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="no_tel_organisasi" class="form-control" placeholder="No Telefon Organisasi">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="emel_organisasi" class="form-control" placeholder="Emel Organisasi">
