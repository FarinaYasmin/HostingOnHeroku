...
<body>
    ...
    <form id="regForm" action="{{ url('/update/pmtk-ipt/'.$i->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="tab">Maklumat Diri :
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="nama_penuh" class="form-control" value="{{ $i->nama_penuh }}">
                    @error('nama_penuh')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Umur :</strong>
                    <input type="text" name="umur" class="form-control" value="{{ $i->umur }}">
                    @error('umur')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="no_kp" class="form-control" value="{{ $i->no_kp }}">
                    @error('no_kp')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="textarea" name="alamat" class="form-control" value="{{ $i->alamat }}">
                    @error('alamat')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="no_tel" class="form-control" value="{{ $i->no_tel }}">
                    @error('no_tel')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Emel :</strong>
                    <input type="text" name="emel" class="form-control" value="{{ $i->emel }}">
                    @error('emel')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
        ...
        <div class="tab">Maklumat Pengajian
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="nama_sklh" class="form-control" value="{{ $i->nama_sklh }}">
                    @error('nama_sklh')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="textarea" name="alamat_sklh" class="form-control" value="{{ $i->alamat_sklh }}">
                    @error('alamat_sklh')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="no_tel_sklh" class="form-control" value="{{ $i->no_tel_sklh }}">
                    @error('no_tel_sklh')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="emel_sklh" class="form-control" value="{{ $i->emel_sklh }}">
                    @error('emel_sklh')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
        ...
        <div class="tab">Maklumat Bank
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="nama_pemilik" class="form-control" value="{{ $i->nama_pemilik }}">
                    @error('nama_pemilik')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="no_akaun_bank" class="form-control" value="{{ $i->no_akaun_bank }}">
                    @error('no_akaun_bank')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
