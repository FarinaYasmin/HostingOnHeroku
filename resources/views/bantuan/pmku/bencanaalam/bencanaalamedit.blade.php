...
<body>
    ...
    <form id="regForm" action="{{ url('/update/pmku-bencanaalam/'.$bencanaalam->id) }}" method="POST" enctype="multipart/form-data">
    @csrf
        ...
        <div class="tab">Maklumat Diri :
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="nama_penuh" class="form-control" value="{{ $bencanaalam->nama_penuh }}">
                    @error('nama_penuh')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Umur :</strong>
                    <input type="text" name="umur" class="form-control" value="{{ $bencanaalam->umur }}">
                    @error('umur')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="no_kp" class="form-control" value="{{ $bencanaalam->no_kp }}">
                    @error('no_kp')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="textarea" name="alamat" class="form-control" value="{{ $bencanaalam->alamat }}">
                    @error('alamat')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="no_tel" class="form-control" value="{{ $bencanaalam->no_tel }}">
                    @error('no_tel')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Emel :</strong>
                    <input type="text" name="emel" class="form-control" value="{{ $bencanaalam->emel }}">
                    @error('emel')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
        ...
        <div class="tab">Maklumat Bank
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="nama_pemilik" class="form-control" value="{{ $bencanaalam->nama_pemilik }}">
                    @error('nama_pemilik')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="no_akaun_bank" class="form-control" value="{{ $bencanaalam->no_akaun_bank }}">
                    @error('no_akaun_bank')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
